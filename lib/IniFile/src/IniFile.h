/*
    Library from git@github.com:stevemarple/IniFile.git

    with some additions to work with KBox by Ronnie Zeiller
*/
#ifndef _INIFILE_H
#define _INIFILE_H
...
#include "Ethernet.h"
  ...
  extern SdFatSdio SD;  // Teensy 3.5/3.6 SDIO support lt. README.md SDFat Library
#else
  // KBox, Teensy 3.2
  extern SdFat SD;
#endif
