...
// Generated on 2018-04-26 11:11:15.605553
...
bool hasNavigationDatetime() const {
  return hasPath(SKPathNavigationDatetime);
};
SKTime getNavigationDatetime() const {
  return this->operator[](SKPathNavigationDatetime).getTimestampValue();
};
bool setNavigationDatetime(SKTime newValue) {
  return setValue(SKPathNavigationDatetime, newValue);
};
...
bool hasNavigationHeadingTrue() const {
  return hasPath(SKPathNavigationHeadingTrue);
};
double getNavigationHeadingTrue() const {
  return this->operator[](SKPathNavigationHeadingTrue).getNumberValue();
};
bool setNavigationHeadingTrue(double newValue) {
  return setValue(SKPathNavigationHeadingTrue, newValue);
};
...
bool hasSteeringRudderAngleTarget() const {
  return hasPath(SKPathSteeringRudderAngleTarget);
};
double getSteeringRudderAngleTarget() const {
  return this->operator[](SKPathSteeringRudderAngleTarget).getNumberValue();
};
bool setSteeringRudderAngleTarget(double newValue) {
  return setValue(SKPathSteeringRudderAngleTarget, newValue);
};
bool hasPerformanceLeeway() const {
  return hasPath(SKPathPerformanceLeeway);
};
double getPerformanceLeeway() const {
  return this->operator[](SKPathPerformanceLeeway).getNumberValue();
};
bool setPerformanceLeeway(double newValue) {
  return setValue(SKPathPerformanceLeeway, newValue);
};
